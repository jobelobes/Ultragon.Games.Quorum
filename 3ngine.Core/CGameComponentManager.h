...
class CORE_API CGameComponentManager
{
	private:
		...
		std::vector<CDrawableGameComponent*> m_lDrawableComponents;
		#pragma endregion
	...
	public:
		...
		int Get_Count();
		std::vector<CGameComponent*>* Get_GameComponents();
		std::vector<CDrawableGameComponent*>* Get_DrawableGameComponents();
		#pragma endregion
