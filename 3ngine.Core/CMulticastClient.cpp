#include "3ngine.Core.h"
		...
		CMulticastClient::CMulticastClient(int receiveBufferSize, int sendBufferSize)
		{
			...
			this->Set_ReceiveBufferSize(receiveBufferSize);
			this->Set_SendBufferSize(sendBufferSize);
		}
